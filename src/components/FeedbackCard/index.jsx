...
export default function FeedbackCard({ name = "Customer", feedback = "Nice app!" }) {
    return (
        <div className="w-[200px] h-[200px] border-[1px] border-[#818589]/[0.3] rounded-[8px] transition duration-500 ease-in-out hover:cursor-default hover:shadow-lg hover:shadow-pale-blue hover:scale-110 ">
            <div className="h-[55%] flex flex-col justify-center items-center bg-pale-blue/[0.3] border-b-[1px] border-[#818589]/[0.3] space-y-[8px]">
                <img src={userLogo} alt="User icon" className="w-[64px] h-[64px]" />
